    ...
    return (
        <div className=' container mx-auto pt-1'>
            ...
            <div className=' container px-2 md:px-5 lg:px-0 mx-auto grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-5'>
                ...
                <Card image={religion} categoryName={'Religion'} route={'/category=religion'} description={description[7]?.description}></Card>
                ...
                <Card image={comics} categoryName={'Comics'} route={'/category=comics'} description={description[8]?.description}></Card>
                <Card image={science} categoryName={'Science'} route={'/category=science'} description={description[10]?.description}></Card>
                <Card image={psychology} categoryName={'Psychology'} route={'/category=psychology'} description={description[10]?.description}></Card>
