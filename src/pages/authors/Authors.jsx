...
function Authors() {
  ...
  return (
    <div className="lg:container lg:mx-auto py-5 mx-5">
      <Title title="Authors" />
      <p className="py-2 text-gray-400 text-sm">Browse books by author</p>
      <div className="grid xl:grid-cols-3 md:grid-cols-2 gap-4 mt-2">
        {authors?.map(x => (
          ...
          >
            <h1 className="font-semibold text-gray-800 group-hover:text-green-700 transition-colors">{x.name}</h1>
            {x.description && (
